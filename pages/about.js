...
const About = () => {
  ...
  const ImageBox = styled.div`
    ...
    img {
      ${(props) => {
        ...
        if (props.discography) {
          return "height: 600px;  box-shadow: none";
        }
      }}
    }
  `;
  ...
  const TextBox = styled.div`
    ...
    ${(props) => {
      ...
      if (props.horizontal) {
        return `width: 500px; text-align: center;`;
      }
      if (props.discography) {
        return `height: 600px; background-color: #fff;`;
      }
    }}
  `;
  ...
  const Text = styled.div`
    ...
    ${(props) => {
      if (props.discography) {
        return `font-size: ${props.theme.fontSize.title};`;
      }
    }}
  `;

                ...
                <Text>
                  <ul>
                    <li>
                      ...
                      앞니 비극의 대부분은 교정할 환자를 보철했을 때 발생합니다.
                    </li>
                    <li>
                  ...
                  <div className="_list">
                    <ul>
                      <li>
                        ...
                        재보철 환자에게도 교정을 권하는 것을 망설이지 않습니다.
                      </li>
                    </ul>
                    <ul>
                      <li>
                    ...
                    <ul>
                      <li>
                        ...
                        치료계획을 세웁니다. 교정 후 보철을 추가하는 이중치료는
                        별로 계획하지 않습니다.
                      </li>
                    </ul>
                    <ul>
            ...
            element={
              <TextBox>
                <Text bigger>
                  ...
                  <ul>
                    <li>
                      발치 교정은 골격에 문제가 있거나 입이 너무 튀어나왔을 때,
                      발치를 하지 않으면 답이 없을 때 합니다. 무분별한 발치
                      교정을 하지 않는 것도 중요하지만 발치 교정이 필요할 때는
                      발치교정을 꼭 하는 것도 중요합니다.
                    </li>
                    <li>
